...
mkdir -p ../vsix
./node_modules/.bin/vsce package -o ../vsix/autocoder-dev-darwin-arm64.vsix -t darwin-arm64
./node_modules/.bin/vsce package -o ../vsix/autocoder-linux-arm64 -t linux-arm64
